...
class plato_detalle4 extends StatefulWidget{

  var broster;

  plato_detalle4([this.broster]);


  @override

  _plato_detalle4 createState() => _plato_detalle4();

}

class _plato_detalle4 extends State<plato_detalle4>{
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          ...
                          height: 275,
                          color: Colors.orange,
                          child: Image.asset('assets/img/pollobroaster.jpg'),
                        ),
                        ...
                        Column(
                          children: [
                            Container(
                              ...
                              child: Text("Pollo Broaster",style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
                            ),
                        ...
                        Text(
                            "Pollo broaster crujiente",style: TextStyle(color: Colors.black,)),
                        SizedBox(
                          height: 110,
                        )
                      ],
                      ...
                      child: Center(
                        child: GestureDetector(
                          ...
                          child: Row(children: [
                            ...
                            const Text(" (S/8.00)",style: TextStyle(color: Colors.black),),
                          ]),
                        ),
                      )),
                )
